defmodule MyAshPhoenixAppWeb.Router do
  ...
  scope "/", MyAshPhoenixAppWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {MyAshPhoenixAppWeb.LiveUserAuth, :live_user_required}
      #
      # If an authenticated user *may* be present:
      # on_mount {MyAshPhoenixAppWeb.LiveUserAuth, :live_user_optional}
      #
      # If an authenticated user must *not* be present:
      # on_mount {MyAshPhoenixAppWeb.LiveUserAuth, :live_no_user}
    end
  end
  ...
  scope "/", MyAshPhoenixAppWeb do
    ...
    auth_routes AuthController, MyAshPhoenixApp.Accounts.User, path: "/auth"
